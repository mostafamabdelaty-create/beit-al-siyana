...
function TechnicianProfilePage() {
  ...
  const trackRequest = async () => {
    try {
      await fetch(`/api/technicians/${id}/track-request`, { method: 'POST' });
    } catch (err) {
  ...
  const submitReview = async () => {
    ...
    try {
      ...
      const reviewsResponse = await fetch(`/api/reviews/technician/${techId}`);
            ...
            <div className="profile-layout">
              ...
              <div className="sidebar-contact">
                <div className="sidebar-contact-card" data-aos="fade-up">
                  ...
                  {isLoggedIn ? (
                    <>
                      <a href={callHref} className="btn-profile-call call"><i className="fas fa-phone-alt" /> اتصل الآن</a>
                      <a href={waHref} target="_blank" rel="noreferrer" className="btn-profile-call whatsapp"><i className="fab fa-whatsapp" style={{ fontSize: '1.2rem' }} /> تواصل عبر واتساب</a>
                    </>
                  ) : (
          ...
          <div className="home-cta" data-aos="fade-up">
            <div className="home-cta-content">
              ...
              <div className="cta-buttons" style={{ marginTop: '30px' }}>
                {isLoggedIn ? (
                  <>
                    <a href={callHref} className="btn btn-white-pill">اتصل الآن</a>
                    <a href={waHref} target="_blank" rel="noreferrer" className="btn btn-dark-pill">تواصل عبر واتساب</a>
                  </>
                ) : (
